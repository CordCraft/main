    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: Text('Currently using Onterra as ${user.activeRole.label.toLowerCase()}'),
          ...
          Center(child: Text('Onterra · platform fee 5% per transaction', style: Theme.of(context).textTheme.bodySmall)),
        ],
      ),
    );
  }
