  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: EmptyState(
        ...
        body: 'To haul on Onterra we need your truck details, photos, calibration certificate, licence and a liveness check. Verified drivers get paid from escrow: half when loaded, half on delivery.',
