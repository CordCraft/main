...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: OnterraTheme.teal,
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 64,
                height: 64,
                decoration: BoxDecoration(color: OnterraTheme.amber, borderRadius: BorderRadius.circular(18)),
                child: const Icon(Icons.local_shipping_rounded, color: OnterraTheme.ink, size: 36),
              ),
              const SizedBox(height: 24),
              Text('Onterra', style: t.displaySmall?.copyWith(color: Colors.white, fontWeight: FontWeight.w800)),
              ...
              const Spacer(flex: 2),
              FilledButton(
                style: FilledButton.styleFrom(backgroundColor: OnterraTheme.amber, foregroundColor: OnterraTheme.ink),
...
class _Step extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: OnterraTheme.amber),
