  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    (String, String, Widget?) content = switch (order.status) {
      ...
      OrderStatus.driverAccepted when isCustomer => (
          ...
          'Pay the haulage fare of ${naira(order.driverFare)} into Ontero escrow. The driver receives half when the truck is loaded and the rest when you confirm delivery.',
      ...
      OrderStatus.completed => ('Completed', 'All escrow released. Thanks for using Ontero.', null),
        ...
        child: Column(
          children: [
            ...
            if (role == AppRole.driver) ...[
              ...
              InfoRow('Ontero fee (5%)', naira(feeDriver + feeProduct)),
            ],
          ],
        ),
      ),
